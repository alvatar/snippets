module xf.utils.Memory;

public {
	import tango.stdc.string : memset;

	version (Nedmalloc) {
		extern (C) void*	nedmalloc(size_t);
		extern (C) void		nedfree(void*);
		extern (C) void*	nedrealloc(void*, size_t);

		alias nedmalloc cMalloc;
		alias nedfree cFree;
		alias nedrealloc cRealloc;
	} else {
