...
private import tango.text.convert.Utf : toString, toString16;
...
bool remove(T, I)(ref T arr, I item, bool crashOnFail = true) {
	static assert (is(typeof(T[0]) == I), "Trying to remove() a " ~ I.stringof ~ " from an array of " ~ T.stringof);
