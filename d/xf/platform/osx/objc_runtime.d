...
import tango.stdc.stdlib : calloc, realloc;
...
void addVariable(id o, char[] name, char[] type, int offset) {
	...
	if (!o.isa.ivars) {
		...
		++o.isa.ivars.ivar_count;
		o.isa.ivars = cast(objc_ivar_list*) realloc (o.isa.ivars, o.isa.ivars.ivar_count * objc_ivar_list.sizeof);
	}
	o.isa.ivars[o.isa.ivars.ivar_count-1].ivar_list[0] = ivar;
}

void addClassMethod(Class meta, SEL name, IMP func, ref objc_method_list method) {
	method.method_count = 1;
	method.method_list[0].method_name = name;
	method.method_list[0].method_imp = func;
	class_removeMethods(meta, &method);
	class_addMethods(meta, &method);
}
