...
// Input event masks. used as event-mask window attribute and as argumets
// to grab requests.

const size_t NoEventMask = 0;
const size_t KeyPressMask = (1L<<0);
const size_t KeyReleaseMask = (1L<<1);
const size_t ButtonPressMask = (1L<<2);
const size_t ButtonReleaseMask = (1L<<3);
const size_t EnterWindowMask = (1L<<4);
const size_t LeaveWindowMask = (1L<<5);
const size_t PointerMotionMask = (1L<<6);
const size_t PointerMotionHintMask = (1L<<7);
const size_t Button1MotionMask = (1L<<8);
const size_t Button2MotionMask = (1L<<9);
const size_t Button3MotionMask = (1L<<10);
const size_t Button4MotionMask = (1L<<11);
const size_t Button5MotionMask = (1L<<12);
const size_t ButtonMotionMask = (1L<<13);
const size_t KeymapStateMask = (1L<<14);
const size_t ExposureMask = (1L<<15);
const size_t VisibilityChangeMask = (1L<<16);
const size_t StructureNotifyMask = (1L<<17);
const size_t ResizeRedirectMask = (1L<<18);
const size_t SubstructureNotifyMask = (1L<<19);
const size_t SubstructureRedirectMask = (1L<<20);
const size_t FocusChangeMask = (1L<<21);
const size_t PropertyChangeMask = (1L<<22);
const size_t ColormapChangeMask = (1L<<23);
const size_t OwnerGrabButtonMask = (1L<<24);

// Key masks. Used as modifiers to GrabButton and GrabKey, results of
// QueryPointer, state in various key-, mouse-, and button-related events.

const size_t ShiftMask = (1<<0);
const size_t LockMask = (1<<1);
const size_t ControlMask = (1<<2);
const size_t Mod1Mask = (1<<3);
const size_t Mod2Mask = (1<<4);
const size_t Mod3Mask = (1<<5);
const size_t Mod4Mask = (1<<6);
const size_t Mod5Mask = (1<<7);

// Button masks. Used in same manner as Key masks above.

const size_t Button1Mask = (1<<8);
const size_t Button2Mask = (1<<9);
const size_t Button3Mask = (1<<10);
const size_t Button4Mask = (1<<11);
const size_t Button5Mask = (1<<12);

const size_t AnyModifier = (1<<15); // used in GrabButton, GrabKey

// Window attributes for CreateWindow and ChangeWindowAttributes

const size_t CWBackPixmap = (1L<<0);
const size_t CWBackPixel = (1L<<1);
const size_t CWBorderPixmap = (1L<<2);
const size_t CWBorderPixel = (1L<<3);
const size_t CWBitGravity = (1L<<4);
const size_t CWWinGravity = (1L<<5);
const size_t CWBackingStore = (1L<<6);
const size_t CWBackingPlanes = (1L<<7);
const size_t CWBackingPixel = (1L<<8);
const size_t CWOverrideRedirect = (1L<<9);
const size_t CWSaveUnder = (1L<<10);
const size_t CWEventMask = (1L<<11);
const size_t CWDontPropagate = (1L<<12);
const size_t CWColormap = (1L<<13);
const size_t CWCursor = (1L<<14);

// ConfigureWindow structure

const size_t CWX = (1<<0);
const size_t CWY = (1<<1);
const size_t CWWidth = (1<<2);
const size_t CWHeight = (1<<3);
const size_t CWBorderWidth = (1<<4);
const size_t CWSibling = (1<<5);
const size_t CWStackMode = (1<<6);

// GC components: masks used in CreateGC, CopyGC, ChangeGC, OR'ed into
// GC.stateChanges

const size_t GCFunction = (1L<<0);
const size_t GCPlaneMask = (1L<<1);
const size_t GCForeground = (1L<<2);
const size_t GCBackground = (1L<<3);
const size_t GCLineWidth = (1L<<4);
const size_t GCLineStyle = (1L<<5);
const size_t GCCapStyle = (1L<<6);
const size_t GCJoinStyle = (1L<<7);
const size_t GCFillStyle = (1L<<8);
const size_t GCFillRule = (1L<<9);
const size_t GCTile = (1L<<10);
const size_t GCStipple = (1L<<11);
const size_t GCTileStipXOrigin = (1L<<12);
const size_t GCTileStipYOrigin = (1L<<13);
const size_t GCFont  = (1L<<14);
const size_t GCSubwindowMode = (1L<<15);
const size_t GCGraphicsExposures = (1L<<16);
const size_t GCClipXOrigin = (1L<<17);
const size_t GCClipYOrigin = (1L<<18);
const size_t GCClipMask = (1L<<19);
const size_t GCDashOffset = (1L<<20);
const size_t GCDashList = (1L<<21);
const size_t GCArcMode = (1L<<22);

// Flags used in StoreNamedColor, StoreColors

const size_t DoRed = (1<<0);
const size_t DoGreen = (1<<1);
const size_t DoBlue = (1<<2);

// Masks for ChangeKeyboardControl

const size_t KBKeyClickPercent = (1L<<0);
const size_t KBBellPercent = (1L<<1);
const size_t KBBellPitch = (1L<<2);
const size_t KBBellDuration = (1L<<3);
const size_t KBLed = (1L<<4);
const size_t KBLedMode = (1L<<5);
const size_t KBKey = (1L<<6);
const size_t KBAutoRepeatMode = (1L<<7);