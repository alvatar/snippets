...
char[][] listthisdir(char[] pathname, char[] pattern) { return listdir(pathname, pattern, false); }
char[][] listdir(char[] pathname, char[] pattern) { return listdir(pathname, pattern, true); }

char[][] listdir(char[] pathname, char[] pattern, bool recurse)
{   char[][] result;
...
/** Ditto */
char[][] listthisdir(char[] pathname, RegExp r) { return listdir(pathname, r, false); }
char[][] listdir(char[] pathname, RegExp r) { return listdir(pathname, r, true); }

char[][] listdir(char[] pathname, RegExp r, bool recurse)
{   char[][] result;
    bool callback(DirEntry* de)
    {
	if (de.isdir)
