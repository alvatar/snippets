...
#endif
static void __sti____cudaRegisterAll_16_test_lib_cpp1_ii_dde60ace(void){__cudaRegisterBinary();__cudaRegisterEntry(_Z6kernelPjS_, (-1));}
#if defined(__cplusplus)
}
#endif
